...
const About = () => {
  return (
    <section id="about" className="py-14 sm:py-20 border-t border-zinc-200/80">
      <div className="max-w-5xl mx-auto px-5 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
          ...
          {/* Main Narrative */}
          <div className="lg:col-span-8 space-y-4 sm:space-y-5 text-base sm:text-lg text-zinc-600 leading-relaxed">
            <p>
          ...
          <div className="lg:col-span-4 bg-zinc-50 border border-zinc-200/80 rounded-xl p-5 sm:p-6 space-y-3.5 text-xs font-medium w-full">
            ...
            <div className="border-t border-zinc-200/60 pt-3">
              <span className="text-zinc-400 uppercase font-mono block mb-0.5">Primary Focus</span>
              <p className="text-zinc-900 text-sm font-semibold">Full-Stack Web &amp; Embedded Systems</p>
            </div>
            <div className="border-t border-zinc-200/60 pt-3">
              <span className="text-zinc-400 uppercase font-mono block mb-0.5">Core Technologies</span>
              <p className="text-zinc-900 text-sm font-semibold">React, Java (Spring), Node.js, Arduino</p>
            </div>
            <div className="border-t border-zinc-200/60 pt-3">
              <span className="text-zinc-400 uppercase font-mono block mb-0.5">Status</span>
